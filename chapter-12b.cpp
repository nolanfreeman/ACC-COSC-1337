...
// 3. flip
//    Step through all the characters in the string,
//    inverting the case of the character (A->a, b->B).
//
// Each function should accept a C-string as an argument.
//
// The main function should accept one string from the user,
// then pass it to each of the functions.
//
// Output:
// The original string, the uppercase, lowercase,
// and flipped case string should all be displayed.
